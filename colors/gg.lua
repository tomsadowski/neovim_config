...
require "tsad_colorscheme_main" {
  ...
  -- normal
  primary    = {11, 184, "#b0b080"}, -- white
  letdecl    = {11, 184, "#b0b080"}, -- white
  enumdecl   = {11, 184, "#b0b080"}, -- white
  path       = {11, 184, "#b0b080"}, -- white
  curlineno  = { 8,   8, "#b0b080"}, -- white
  msgarea    = { 8,   8, "#b0b080"}, -- white
