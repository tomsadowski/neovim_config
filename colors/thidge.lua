...
-- 08 FG: String, DiagnosticOk*, UI stuff
local fg_mlg    = '#cbcbb7'
local ct_fg_mlg = 158

-- 09 **: DiagnosticWarn* FG, UI stuff FG, CurSearch BG, IncSearch BG
local fg_yel    = '#ffff87'
local ct_fg_yel = 228

-- 10 FG: DiagnosticError*, UI stuff 
local fg_red    = '#ffd7af'
local ct_fg_red = 223 

-- 11 **: CurSearch FG, IncSearch FG, misc BG
local bg_edg    = '#000000'
local ct_bg_edg = 232 
...
-- 14 BG: Folded, Pmenu, StatusLineNC
local bg_mu1    = '#262626'
local ct_bg_mu1 = 235

-- 15 **: UI stuff **, LineNr FG, MatchParen BG, Visual BG
local bg_mu2    = '#4e4e4e'
local ct_bg_mu2 = 239
...
-- 17 BG: DiffAdd and RedrawDebugComposed
local bg_grn    = '#005f00'
local ct_bg_grn = 22

-- 18 BG: Search, Substitute, RedrawDebugClear
local bg_yel    = '#875f00'
local ct_bg_yel = 94 

-- 19 BG: Error and RedrawDebugRecompose
local bg_red    = '#5f0000'
local ct_bg_red = 52
...
local definition_maps = {
  ...
  Identifier     = {fg=fg_nor, ctermfg=ct_fg_nor}, 
  Error          = {fg=fg_edg, bg=bg_red, ctermfg=ct_fg_edg, ctermbg=ct_bg_red}, 
  Todo           = {fg=fg_nor, bold=true}, 
  Operator       = {fg=fg_nor}, 
  Delimiter      = {fg=fg_nor}, 
  Comment        = {fg=fg_mu2, bg=bg_nor, bold=false}, 
  Boolean        = {link='Constant'}, 
  Number         = {link='Constant'}, 
  Float          = {link='Number'}, 
  Statement      = {fg=fg_nor, bold=false}, 
